...
export default class IntentCheckStep extends BaseStep {
    ...
    static get editorSchema() {
        return {
            fields: [
                { key: "title", label: "Step Title", type: "text", default: "Intent Check" },
                { key: "question", label: "Question", type: "textarea", default: "What is your goal?" },
                {
                    key: "options",
                    label: "Options",
                    type: "array",
                    // No itemSchema denotes simple array of strings/numbers
